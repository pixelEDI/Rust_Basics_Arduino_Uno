...
// genaue Erklaerung: https://blog.rahix.de/005-avr-hal-millis/
...
fn main() -> ! {
    ...
    loop {
        ...
        if current_millis - previous_millis > 100 {
            ...
            led.toggle();
            // ufmt::uwriteln!(&mut serial, "LED toggle {} ms",current_millis).unwrap_infallible();
        }
